...
gloss: Turning an impression into a description another person could verify
...
ourSummary: >-
  ...
  count and a duration than with an adjective.
plainSummary: >-
...
pairs:
  ...
  - id: manipulative
    ...
    objective: >-
      Said she needed the bathroom at the start of 4 of 6 work blocks, and returned within
      a minute each time without using it.
    why: >-
      Manipulative attributes a motive. The description carries the same information about
      a possible escape function without the app or the writer deciding the function.
  - id: refused
    vague: Refused to comply.
    objective: >-
      Did not begin the task within 10 seconds of the instruction on 8 of 12 trials, and
      began within 10 seconds after one repeat of the instruction on 5 of those.
    why: >-
  ...
  - id: aggressive
    ...
    objective: >-
      ...
      staff, no injuries.
    why: >-
      Aggressive covers everything from a raised voice to an injury. Naming the topography
      and stating whether anybody was hurt is what an incident review will ask for anyway.
  - id: tantrum
  ...
  - id: good-session
    ...
    objective: >-
      11 of 14 targets independent, up from 8 last session. Accepted the transition to the
      table on the first instruction both times.
    why: >-
      A compliment is not a record. The same sentiment with numbers tells the next reader
      what to keep doing.
  - id: seemed-tired
    vague: Seemed tired and unmotivated.
    objective: >-
      Yawned repeatedly, put his head on the table 4 times, and worked for preferred items
  ...
  - id: attention-seeking
    ...
    why: >-
      Naming a function in a note states a conclusion that comes from an assessment. The
      count and what followed it are the evidence for it, which is what your supervisor
      wants.
  - id: sensory
    vague: Doing it for sensory reasons.
    objective: >-
      Rocked and hummed for roughly 3 minutes at a time, in 5 episodes, all of them when
      no task was in front of him and no adult was interacting with him.
    why: >-
  ...
  - id: caregiver-uncooperative
    ...
    why: >-
      ...
      more useful.
  - id: nonverbal
    vague: He is nonverbal.
    objective: >-
      Communicated using a speech-generating device and by leading an adult by the hand.
      No vocal words observed this session.
    why: >-
  ...
  - id: better-behavior
    ...
    why: >-
      ...
      and makes the note worth reading beside a graph.
  - id: worked-hard
    vague: Tried really hard.
    objective: >-
...
attestation:
  ...
  aiAssisted: true
  consulted: >-
    Pairs written from the requirement for operational definitions in Baer, Wolf and Risley
    (1968) and the documentation standards in the technician code. Every example is
    invented; no real note, learner or session was consulted.
review:
  status: in-review
  authoredBy: claude
...
Fourteen phrases people actually write, and the same observation said so that another
person could have counted it.
