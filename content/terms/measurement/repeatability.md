...
id: repeatability
term: Repeatability
aliases: [countability, repeatability of behavior]
...
nonExamples:
  - text: >-
    ...
    setting: clinic
  - text: >-
      How long a tantrum lasted. That is temporal extent, a different property, and no
      amount of counting captures it.
    setting: home
contrastWith: [temporal-extent, temporal-locus]
seeAlso: [count, frequency-and-rate, celeration]
flashcard:
  mnemonic: >-
    Repeatable means countable. Count, rate and celeration all rest on this one.
taskRefs:
...
Exam items often turn on exactly this. "How often" is repeatability. "How long" is
temporal extent. "When, relative to something else" is temporal locus.
