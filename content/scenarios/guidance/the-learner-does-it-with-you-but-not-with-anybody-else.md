---
id: the-learner-does-it-with-you-but-not-with-anybody-else
kind: guidance
title: The skill works with you and nowhere else
situation: >-
...
steps:
  ...
  - text: >-
    ...
    rationale: >-
      A skill nobody has measured outside the teaching arrangement has not been shown to
      exist outside it.
  - text: >-
      Tell your supervisor what transferred and what did not.
    rationale: >-
      Which dimension the skill is stuck on determines what happens next, and that detail is
      only visible to whoever ran it.
whatNotToDo:
  - >-
...
attestation:
  ...
  aiAssisted: true
  consulted: >-
    Written from the generalization literature, principally the
    technology-of-generalization framework.
review:
  status: in-review
  authoredBy: claude
