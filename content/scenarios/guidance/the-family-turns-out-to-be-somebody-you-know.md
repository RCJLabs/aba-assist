...
steps:
  - text: >-
      Tell your supervisor as soon as you notice, before the next session if you can.
    rationale: >-
...
whatNotToDo:
  - >-
    Do not decide by yourself that the connection is too small to mention.
  - >-
    Do not discuss the learner in the setting where you know the family.
  - >-
...
termRefs:
  [dual-relationship, conflict-of-interest, confidentiality, ethics-code, continuity-of-care]
taskRefs:
  - { credential: RBT, code: F.7 }
  - { credential: RBT, code: F.5 }
  - { credential: RBT, code: E.2 }
  - { credential: BCBA, code: E.7 }
tags: [boundaries, ethics, conflict]
citations:
...
attestation:
  ...
  aiAssisted: true
  consulted: >-
    Written from both ethics codes on multiple relationships and conflicts of interest.
review:
  status: in-review
  authoredBy: claude
