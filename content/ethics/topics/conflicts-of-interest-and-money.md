...
ifYouAreUnsure: >-
  Write down who benefits from each option in front of you. If you would be uncomfortable
  explaining the arrangement to the family, that discomfort is the answer.
termRefs: [conflict-of-interest, dual-relationship, informed-consent, evidence-based-practice]
scenarioRefs: [a-family-offers-you-a-gift]
relatedTopics: [multiple-relationships, gifts, ending-and-handing-over-services]
taskRefs:
...
citations:
  - sourceId: bacb-ethics-code-2022
    ...
    locator: Client and stakeholder responsibilities
attestation:
  originalProse: true
  noVerbatimSource: true
  aiAssisted: true
  consulted: >-
    Written from the analyst code's standards on client responsibilities, agreements and
    conflicts of interest, in our own words.
review:
  status: in-review
  authoredBy: claude
