...
relatedTopics: [multiple-relationships, conflicts-of-interest-and-money]
taskRefs:
...
attestation:
  ...
  aiAssisted: true
  consulted: >-
    Written from both codes' standards on gifts and the RBT outline's ethics task, in our
    own words.
review:
  status: in-review
  authoredBy: claude
...
Families often want to give something because the work matters to them. Declining well
matters: attribute it to the rules you work under rather than to the gesture, and the
relationship survives intact.
